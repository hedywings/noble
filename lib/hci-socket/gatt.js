        ...
        if (Array.isArray(charLocation)) {
          charLocation.forEach(function (char) {
            if (char.valueHandle === valueHandle)
              this.emit('notification', this._address, serviceUuid, characteristicUuid, char.valueHandle, valueData);
          });
        } else {
      ...
      for (i = 0; i < characteristics.length; i++) {
        ...
        if (charLocation) {
          if (!Array.isArray(charLocation)) {
            ...
            charLocation = characteristicList;
          }
          
          charLocation.push(characteristics[i]);
        } else {
